...
# adding "source dataset name" variable
#X_test$srcDSType <- "test"
#X_train$srcDSType <- "train"

# adding level to the factor 'features' of feature-labels
#features <- factor(features, levels = c(levels(features), "srcDSType"))

#adding an element of srcDSType to the previously added level
#features[562] <- "srcDSType"
